...
$sql="update company set NameCom=:NameProfile where idCom=:did";
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Modification Société</div>
                    </div>
...
<?php 
$did=intval($_GET['deptid']);
$sql = "SELECT * from company WHERE idCom=:did";
$query = $dbh -> prepare($sql);
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->execute();
...
{               ?>  
                                        ...
                                        <div class="row">
                                            ...
                                            <p style="color:#008B8B;">Nom de Société</p>
<input id="departmentname" type="text"  class="validate" autocomplete="off" name="NameProfile" value="<?php echo htmlentities($result->NameCom);?>"  required>
