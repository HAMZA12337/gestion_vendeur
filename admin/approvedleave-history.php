...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title> DRH|Congés Accordés</title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Historique des congés Accordés</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                            <marquee> <span class="card-title">Liste des Congés Accordés </span></marquee>
