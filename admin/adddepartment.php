...
$sql="INSERT INTO tbldepartments(DepartmentName,DepartmentShortName,idchefD) VALUES(:deptname,:deptshortname,:choix)  ";
$query = $dbh->prepare($sql);
$query->bindParam(':deptname',$deptname,PDO::PARAM_STR);
...
if($lastInsertId)
{
$msg="Départment est bien Crée";
header('location:managedepartments.php');
}
else 
{
$error="Cette Objet déja existe";
}
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Ajouter Départment</div>
                    </div>
...
<input id="departmentname" type="text"  class="validate" autocomplete="off" name="departmentname" required >
                                                <label for="deptname">Nom de Départment </label>
                                            </div>


          <div class="input-field col s12">
<input id="departmentshortname" type="text"  class="validate" autocomplete="off" name="departmentshortname"  >
                                                <label for="deptshortname">Abréviation de département</label>
                                            </div>
<div class="input-field col s12">
<select  name="choix" autocomplete="off"  size="3">
<option value="" disabled selected>Nom chef departement</option>
<?php $sql = "SELECT id,FirstName,LastName from tblemployees t join categorie c on t.IdCa=c.IdCa where Casechef!= 0 ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
