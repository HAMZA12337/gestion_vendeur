...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>DRH |Demande Refusé </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"> Historique des demandes de congés Refusé</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                            <marquee>    <span class="card-title">La liste des demandes Refusés</span></marquee>
                                <?php if($msg){?><div class="succWrap"><strong>SUCCESS</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            <th  width="120">Numéro</th>
                                            <th width="180">Nom d'employé</th>
