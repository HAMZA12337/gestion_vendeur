...
$username=$_SESSION['alogin'];
    $sql ="SELECT Passsword FROM tblemployees WHERE EmpId=:username and Passsword=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblemployees set Passsword=:newpassword where EmpId=:username";
