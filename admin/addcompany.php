...
//
$sql= "SELECT * from company where NameCom=:NameCom";
...
if($query->rowCount() == 0)
{
    ...
    //
$sql="INSERT INTO company(NameCom) VALUES(:NameProfile)";
$query = $dbh->prepare($sql);
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Ajouter Société</div>
                    </div>
...
<input id="departmentname" type="text"  class="validate" autocomplete="off" name="departmentname"  required>
                                                <label for="deptname">Nom de  Société</label>
                                            </div>
                                            <div class="input-field col s12">
