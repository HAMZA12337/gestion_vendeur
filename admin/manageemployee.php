...
$sql = "SELECT v.nomp,v.prenom,v.cin,v.cnss,v.date_naissance,v.date_entree,v.code_sage,s.nom_secteur,v.pda,r.nom from vendeur v join secteur s on v.pda=s.pda join region r on s.id_region=r.id";
$query = $dbh -> prepare($sql);
$query->execute();
