...
$sql="update region set nom=:deptname  where id=:did";
...
<?php 
$did=intval($_GET['deptid']);
$sql = "SELECT * from region WHERE id=:did";
$query = $dbh -> prepare($sql);
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->execute();
...
{               ?>  
                                        ...
                                        <div class="row">
                                            ...
                                            <p style=" color:#008B8B;">Nom de Region</p>
<input id="departmentname" type="text"  class="validate" autocomplete="off" name="departmentname" value="<?php echo htmlentities($result->nom);?>"  required>
