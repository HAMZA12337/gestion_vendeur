...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title> DRH | Demande de congé </title>
                ...
                <div class="row">
                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            ...
                            <marquee>   <span class="card-title">Toutes les demandes de congés(Nouveaux-Accordés-Refusés)</span></marquee>
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="180">Matricule</th>
                                            <th width="180">Type de congé</th>
...
{         
      ?>  
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="editemployee.php?empid=<?php echo htmlentities($result->id);?>" target="_blank"><?php  echo htmlentities($result->EmpId);?></a></td>
...
if($stats==1){    
 ...
 <?php } ?>
           ...
           <td><a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn blue m-b-xs"  >Afficher les Details</a></td>
                                    </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
