...
$StateComp=$_POST['StateComp'];
$NbDay=$_POST['NbDay'];
$sql="INSERT INTO tblleavetype(LeaveType,StateComp,NbDay) VALUES(:leavetype,:StateComp,:NbDay)";
$query = $dbh->prepare($sql);
$query->bindParam(':leavetype',$leavetype,PDO::PARAM_STR);
$query->bindParam(':StateComp',$StateComp,PDO::PARAM_STR);
$query->bindParam(':NbDay',$NbDay,PDO::PARAM_STR);
$query->execute();
$lastInsertId = $dbh->lastInsertId();
if($lastInsertId)
{
$msg="Type de congé est bien ajouté";
header('location:manageleavetype.php');
}
else 
{
$error="Vous avez un Erreur.";
}
...
<div class="input-field col s12 m6">
<p >Nombre de jour</p>
<input type="number" id="tentacles" name="NbDay" min="1"  value="0" style="font-size:25px;">
